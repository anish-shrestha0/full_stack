...
<body>
    <header class="navbar">
        ...
        <div class="search-bag-account">
            ...
            <a href="" class="nav-link"><i class="fa-solid fa-bag-shopping bag nav-icon m-1em"></i><span
                    class="cart-items-no">0</a>
            <a href="" class="nav-link acc-icon"><i class="fa-solid fa-user user nav-icon m-1em log-sign">&nbsp;<i
                        class="fa-solid fa-caret-down crt"></i></i></a>
            <div class="register">
